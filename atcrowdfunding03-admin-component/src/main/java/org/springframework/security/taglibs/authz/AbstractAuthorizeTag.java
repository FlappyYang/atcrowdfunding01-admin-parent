...
public abstract class AbstractAuthorizeTag {
    ...
    private SecurityExpressionHandler<FilterInvocation> getExpressionHandler() throws IOException {
        ...
        ApplicationContext attribute = (ApplicationContext) servletContext.getAttribute(attrName);

        Map<String, SecurityExpressionHandler> handlers = attribute.getBeansOfType(SecurityExpressionHandler.class);
