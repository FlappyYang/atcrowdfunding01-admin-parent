...
/**
 * @author 杨鹏炜
 * @data 2021/4/10  14:16:42
 * @Configuration 表示当前类是一个配置类@Configuration
 * @EnableWebSecurity 启用web环境下权限控制功能@EnableWebSecurity
...
public class WebAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    /**
     * 在这里声明无法在xxxService中装配，因为这里是SpringMVC容器中的组件，xxxService是Spring容器中的组件
     *
